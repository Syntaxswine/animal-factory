...
function contactEnds(s){for(const u of squad(s))if(u.quitPending){if(u.social.happiness===0)quitMerc(s,u);else u.quitPending=false;} // a meter that rose again before the end is no longer quitting
