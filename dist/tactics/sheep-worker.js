...
export function createSheepWorker(data,rifleTexture=null){
 const worker=createWorkerRig(data,rifleTexture),materials=worker.parts.map((p,i)=>new THREE.MeshStandardMaterial({color:[0xe3d8b3,0x85613c,0xe8d9af,0x605444,0xd8c79e,0x605444,0x77736a,0xe8d9af,0x687342,0xb52213][i],roughness:.9}));
