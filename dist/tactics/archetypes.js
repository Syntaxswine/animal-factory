...
export const ARCHETYPES={
 Innocent:{hit:['That was me! You shot me!','Again? Please stop. Please.','Stop it! Stop it, I said!'],wants:'safety and simple happiness',fears:'doing something wrong',speaks:'plainly, trusts first',fails:'denial: ignoring what is ugly until it bites',radius:8,traits:T(60,30,30,80,20,30,60,85,70,40),
 ...
 Everyman:{hit:['Oi. Other way, mate.','Twice now. That is not an accident.','Right. Have some back, then.'],wants:'to belong',fears:'standing out, being left behind',speaks:'common sense, understatement',fails:'going along with the crowd against their own judgment',radius:12,traits:T(50,45,30,85,35,35,60,60,75,50),
 ...
 Hero:{hit:['Is that the best you can do?','Shoot me again and see what happens.','You were warned.'],wants:'to prove worth through hard action',fears:'weakness',speaks:'challenges and deadlines',fails:'arrogance: picking fights that did not need fighting',radius:16,traits:T(60,85,95,40,85,80,55,30,60,45),
 ...
 Explorer:{hit:['Wrong direction. Everything is, with you.','You again. I should have kept walking.','Fine. Let us see who is faster.'],wants:'freedom and new ground',fears:'being trapped or conforming',speaks:'restlessly, about the next place',fails:'never committing, wandering when staying was the task',radius:6,traits:T(85,50,80,20,50,55,30,55,40,60),
 ...
 Rebel:{hit:['Do that again. I dare you.','That is two. I count.','Nobody shoots me for free.'],wants:'to break what is broken',fears:'being powerless',speaks:'bluntly, provokes on purpose',fails:'destroying things that worked, revolt as habit',radius:0,traits:T(55,75,90,10,90,75,20,20,35,55),
 ...
 Lover:{hit:['You... you hit me. How could you?','It hurts more the second time.','If that is how it is, so be it.'],wants:'intimacy and beauty',fears:'being unwanted',speaks:'sensory detail and devotion',fails:'losing self in the other, pleasing rather than telling the truth',radius:10,traits:T(45,35,40,65,30,50,45,70,85,50),
 ...
 Creator:{hit:['Sloppy work. That was my arm.','A pattern. I keep notes on patterns.','Corrected.'],wants:'to make something that lasts',fears:'mediocrity',speaks:'ideas and half-finished sketches',fails:'perfectionism, never shipping',radius:10,traits:T(55,45,25,45,30,60,75,50,55,40),
 ...
 Sage:{hit:['Your aim, statistically, favours me.','Twice is a trend, not an accident.','Hypothesis: you will not do it a third time.'],wants:'to understand',fears:'being deceived or ignorant',speaks:'carefully, cites, qualifies',fails:'paralysis: studying instead of acting',radius:8,traits:T(90,50,20,55,25,55,85,55,50,30),
 ...
 Magician:{hit:['Careful. I am a moving part.','The same fault, twice. Interesting.','Every action has a consequence. This one.'],wants:'to transform situations',fears:'unintended consequences',speaks:'systems and hidden levers',fails:'manipulation: treating people as parts',radius:6,traits:T(70,60,65,25,55,65,60,35,40,45),
