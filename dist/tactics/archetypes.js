// Twelve Jungian archetypes (GUARDS.md G3). Guards draw one at map creation; the four authored mercs carry a tag.
...
export const ARCHETYPES={
 Innocent:{wants:'safety and simple happiness',fears:'doing something wrong',speaks:'plainly, trusts first',fails:'denial: ignoring what is ugly until it bites',radius:8,traits:T(60,30,30,80,20,30,60,85,70,40),
 ...
 Everyman:{wants:'to belong',fears:'standing out, being left behind',speaks:'common sense, understatement',fails:'going along with the crowd against their own judgment',radius:12,traits:T(50,45,30,85,35,35,60,60,75,50),
 ...
 Hero:{wants:'to prove worth through hard action',fears:'weakness',speaks:'challenges and deadlines',fails:'arrogance: picking fights that did not need fighting',radius:16,traits:T(60,85,95,40,85,80,55,30,60,45),
 ...
 Caregiver:{wants:'to protect others',fears:'selfishness in themselves',speaks:'warmly, asks what you need',fails:'martyrdom and smothering, helping past the point of being asked',radius:14,traits:T(65,55,60,60,30,40,70,80,95,35),
 ...
 Explorer:{wants:'freedom and new ground',fears:'being trapped or conforming',speaks:'restlessly, about the next place',fails:'never committing, wandering when staying was the task',radius:6,traits:T(85,50,80,20,50,55,30,55,40,60),
 ...
 Rebel:{wants:'to break what is broken',fears:'being powerless',speaks:'bluntly, provokes on purpose',fails:'destroying things that worked, revolt as habit',radius:0,traits:T(55,75,90,10,90,75,20,20,35,55),
 ...
 Lover:{wants:'intimacy and beauty',fears:'being unwanted',speaks:'sensory detail and devotion',fails:'losing self in the other, pleasing rather than telling the truth',radius:10,traits:T(45,35,40,65,30,50,45,70,85,50),
 ...
 Creator:{wants:'to make something that lasts',fears:'mediocrity',speaks:'ideas and half-finished sketches',fails:'perfectionism, never shipping',radius:10,traits:T(55,45,25,45,30,60,75,50,55,40),
 ...
 Jester:{wants:'to enjoy the moment, make others laugh',fears:'boredom, being boring',speaks:'jokes that carry the true thing',fails:'frivolity, joking through the moment that needed seriousness',radius:12,traits:T(40,40,55,30,45,45,25,65,60,95),
 ...
 Sage:{wants:'to understand',fears:'being deceived or ignorant',speaks:'carefully, cites, qualifies',fails:'paralysis: studying instead of acting',radius:8,traits:T(90,50,20,55,25,55,85,55,50,30),
 ...
 Magician:{wants:'to transform situations',fears:'unintended consequences',speaks:'systems and hidden levers',fails:'manipulation: treating people as parts',radius:6,traits:T(70,60,65,25,55,65,60,35,40,45),
 ...
 Ruler:{wants:'order and control',fears:'chaos, being overthrown',speaks:'decisions and responsibilities',fails:'authoritarianism: control past the point of usefulness',radius:20,traits:T(70,70,45,50,55,85,90,30,65,25),
