...
const dir=new URL('../docs/tactics/hybrid-review/dog-guard/',import.meta.url);
...
try{
 ...
 await page.goto('http://127.0.0.1:4427/tactics/dog-guard.html?mesh=10k');
 ...
 const regressions=[];
 for(const species of ['horse-light','goat-worker','bull-worker','cow-worker','rabbit-worker']){
  await page.goto(`http://127.0.0.1:4427/tactics/${species}.html?mesh=10k`);
 ...
 console.log('Dog detail review: 20 close-up views and 5 high-DPI character regressions, no browser errors.');
