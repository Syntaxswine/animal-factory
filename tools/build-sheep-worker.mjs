...
function coatMesh(){
 ...
 function point(a,t,layer){const front=smooth(Math.cos(a),.05,.65),hem=.871-.055*Math.exp(-1*((Math.abs(Math.sin(a))-.43)/.23)**2)*front,neck=1.292-.175*(1-smooth(Math.abs(Math.sin(a)),.06,.68))*front,y=hem+(neck-hem)*t;
