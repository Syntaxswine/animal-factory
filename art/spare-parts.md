...
## User-annotated corner guide

Used the supplied green-line annotation (saved as `art/spare-parts-user-guide.png`) alongside the clean sprite as references for a built-in image_gen edit. Retained soft highlights, rounded hex fasteners and transparent background. Guide coordinates are targets for the generated edit, not a guarantee of pixel-exact geometry.

Use case: precise-object-edit. Image 1 is the clean transparent spare-parts sprite to edit. Image 2 is the user's geometric correction guide: its lime-green lines show desired corner positions and three edge directions on three fasteners. Apply those exact guide directions to the underlying metal geometry in image 1. At the left foreground nut the three edges meet around (366,840) and extend toward (459,780), (430,877), and (340,929). At the right bolt rear head they meet around (840,782) and extend toward (914,730), (886,817), (821,857). At the right foreground nut meet around (1014,911) and extend toward (1097,855), (1064,945), (990,989). These define the local top/side corner, NOT the complete outline; preserve full six-sided hexagonal fastener profiles, centered bores and straight threaded shafts. Correct local facet orientation and corner positions following these guides while retaining gently rounded worn corners and broad ivory highlights from image 1. Preserve all unmarked sprite parts, gears, copper, spring, materials, composition and original 1254 square canvas. Output only finished clean art on genuine transparent alpha. Do NOT copy the guide's white background, green marks or heavy black outline. No guide strokes, text, labels, new objects or rectangular bolt heads.
