...
**Built 2026-09-17** on branch `tactics-guard-states`, on top of the playtest follow-ups (`threatens()`, `stepInvestigation`, the engagement economy). Tests: `tests/tactics-guard-states.test.mjs` (eleven cases) plus two re-pinned cases in `tests/tactics-pacing.test.mjs`.
