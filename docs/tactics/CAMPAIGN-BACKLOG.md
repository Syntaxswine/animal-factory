...
Tree: the authored factory map (12 guards, four comrades) is the opening. The clock runs one
...
a rest, a hire on a day contract at $100 as the cheap demonstration with the week contract as the
trap to warn about, the workshop investment, travel to a second map); whether the week is a
...
scarcity and loot were built, repairs were not. Inventory is a spatial 4x4 backpack with two
